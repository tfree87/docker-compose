...
[[https://github.com/Forceu/barcodebuddy][Barcode Buddy]] provides a web-based user interface that interacts with Grocy. Barcode Buddy makes looking up data from product barcodes fast and easy so that creating the Grocy database is easier to start.
* Contents
